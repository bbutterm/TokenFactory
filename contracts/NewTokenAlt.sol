...
contract NewToken is ERC20 {
    ...
    modifier onlyStaked(){
        require (lockedTokens[tx.origin]>=stakeMin,"You didint stake enough coins");
        _;
    }
    modifier stakeReady(){
        require(stakes[tx.origin].date+stakes[tx.origin].term<block.timestamp,"not enough time");
        _;
    }
...
//always true need to fix work with time
    function checkStake() public onlyStaked stakeReady view returns(bool) {
        return true;
    }
